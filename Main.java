class Main {
    public static void main(String[] args) {
        ...
        arr = m.bubbleSort(arr);
        long endTime = System.nanoTime() - startTime;

        System.out.println("Array size: " + arr.length);
        System.out.println("Time in nano seconds using Bubble Sort: " + endTime);
        ...
        System.out.println("");
        System.out.println("Array size: " + vector800.length);
        System.out.println("Time in nano seconds using Merge Sort: " + endTime2);
    }
